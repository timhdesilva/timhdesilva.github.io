...
\newcommand{\cvsec}[1]
{
	% Keep from breaking right after section. Adjust "4" to larger number if page is still breaking.
...
{
	\cvsec{#1}
	% Breakable 1:6-ish date/text layout.
	\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.16\linewidth}@{\hspace{0.02\linewidth}}>{\raggedright\arraybackslash}p{0.82\linewidth}@{}}
}
{
	\end{longtable}
}
...
\begin{cvchrono}{ACADEMIC POSITIONS}
	\cvitem{2025-}{Assistant Professor of Finance, {\scshape Stanford University, Graduate School of Business}}
	\cvitem{2026--2027}{Spence Faculty Scholar, {\scshape Stanford University, Graduate School of Business}}
	\cvitem{2025-}{Faculty Affiliate, {\scshape Stanford Human-Centered Artificial Intelligence Institute}}
	\cvitem{2025-}{Affiliated Researcher, \textsc{MIT Sloan Consumer Finance Initiative}}
...
\begin{cvcontinue}{WORKING PAPERS}
	\item \href{https://www.timdesilva.me/files/papers/depopulation.pdf}{Making Room on an Empty Planet: The Spatial Consequences of Depopulation}, with James D. Paron.
	\item \href{https://www.timdesilva.me/files/papers/llm_advice.pdf}{AI Financial Advice: Supply, Demand, and Life Cycle Implications}, with Taha Choukhmane, Weidong Lin, and Matthew Akuzawa
	\begin{itemize}
		\item Winner of \emph{Swiss Finance Institute Outstanding Paper Award}
	\end{itemize}
...
\begin{cvcontinue}{PEER-REVIEWED PUBLICATIONS}
	...
	\begin{itemize}
		\item Runner-Up for \emph{Michael J. Brennan Best Paper Award}
	\end{itemize}
\end{cvcontinue}

\begin{cvcontinue}{OTHER PUBLICATIONS AND INACTIVE WORKING PAPERS}
...
\begin{cvchrono}{AWARDS, FELLOWSHIPS, AND GRANTS}
	\cvitem{2026}{Spence Faculty Scholar (2026--2027), IQAM Best Paper Award, Cognitive Foundations in Finance Conference Best Paper Award, Swiss Finance Institute Outstanding Paper Award}
	\cvitem{2025}{Michael J. Brennan Best Paper Award (Runner-Up), Stanford IFDM Research Funding Grant}
...
\begin{cvchrono}{PRESENTATIONS (INCLUDES SCHEDULED)}
		\cvitem{2026}{{\itshape Seminars}: Federal Reserve Bank of Philadelphia (x2), Duke Economics, CIBC Finance Innovations \& AI Seminar, NYU Stern, Harvard Business School, Stanford AFTLab FinTech Seminar \newline {\itshape Conferences}: CEPR 11th European Workshop on Household Finance, FMG Conference on Cognitive Foundations of Finance, WFA, NBER SI Household Finance, Stanford SITE Public Economics, SIEPR Conference on Budget Analysis and Public Policy, NBER Macroeconomic Effects of Population Aging}
	\cvitem{2025}{\textit{Seminars}: BYU, Berkeley Haas, Washington Foster, T. Rowe Price Research Group, BlackRock, Federal Reserve Board of Governors, Berkeley Economics  \newline \textit{Conferences}: AFA, Q Group (Spring), Stanford Financial Education Symposium, NBER Behavioral Finance (Spring), BFI Conference on Rational Inattention, WFA, NBER SI Forecasting \& Empirical Methods, SITE Financial Regulation, SITE Macroeconomics of Uncertainty and Volatility, NBER Monetary Economics (Fall), NBER Asset Pricing (Fall)}
	\cvitem{2024}{\textit{Seminars}: Chicago Booth, Princeton, Yale SOM, Harvard Business School, Harvard Economics, London School of Economics, London Business School, Wharton, UCLA Anderson, Stanford GSB, Northwestern Kellogg, Berkeley Haas, Columbia Business School, NYU Stern, Boston College Carroll, Bocconi, OSU Fisher, Claremont McKenna College, USC Marshall \newline \textit{Conferences}: Top Finance Graduate Award Conference (HEC Paris), SFS Cavalcade, WFA, Policy Impacts Annual Conference, SITE Market Failure and Public Policy, Swedish House of Finance Workshop on Household Debt Relief, Brookings New Doctoral Research in Tax Policy \& Public Finance, NBER Public Economics (Fall), NBER Economics of Education (Fall), SIEPR Financial Literacy Colloquia, e61 Micro 4 Macro Conference}
	\cvitem{2023}{\textit{Seminars}: Inter-Finance PhD Seminar \newline \textit{Conferences}: Olin Finance Conference (PhD Poster Session), Financial Research Association (FRA) Conference, BlackRock Applied Research Award Panel}
	\cvitem{2022}{\textit{Seminars}: Quantbot Technologies, Inter-Finance PhD Seminar \newline \textit{Conferences}: WFA, BSE PhD Workshop on Expectations in Macroeconomics}
	\cvitem{2021}{\textit{Conferences}: Transatlantic Doctoral Conference, SoFiE Annual Conference}
	\cvitem{2020}{\textit{Conferences}: Stanford GSB Rising Scholars Conference}
\end{cvchrono}
...
\begin{cvchrono}{PROFESSIONAL ACTIVITIES}
	\cvitem{Referee}{\emph{Quarterly Journal of Economics, Journal of Political Economy, American Economic Review, Review of Economic Studies, Journal of Finance, Review of Financial Studies, Journal of Financial Economics, Journal of Political Economy Macroeconomics, American Economic Journal: Economic Policy, Review of Economics and Statistics, Management Science, Journal of Financial Econometrics, Journal of Banking and Finance, Journal of Accounting and Economics, The Accounting Review}}
	\cvitem{Program Committee}{MFA 2025, SFS Cavalcade 2025, WFA 2025, FMA 2025, NFA 2025, SFS Cavalcade 2026, WFA 2026, EFA 2026, FMA 2026}
\end{cvchrono}
