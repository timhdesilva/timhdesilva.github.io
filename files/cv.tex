...
\begin{cvchrono}{PRESENTATIONS (INCLUDES SCHEDULED)}
	\cvitem{2025}{\textit{Seminars}: BYU, Berkeley Haas, Washington Foster, T. Rowe Price Research Group, Federal Reserve Board of Governors \newline \textit{Conferences}: AFA, Q Group (Spring), Stanford Financial Education Symposium, NBER Behavioral Finance (Spring), BFI Conference on Rational Inattention, WFA, NBER Forecasting \& Empirical Methods}
