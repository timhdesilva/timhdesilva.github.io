...
\begin{cvchrono}{PRESENTATIONS (INCLUDES SCHEDULED)}
	\cvitem{2025}{\textit{Seminars}: BYU, Berkeley Haas, Washington Foster, Federal Reserve Board of Governors \newline \textit{Conferences}: AFA, Q Group (Spring), NBER Behavioral Finance (Spring), Stanford Financial Education Symposium, BFI Conference on Rational Inattention, WFA, Chicago Booth Conference in Behavioral Finance and Decision-Making}
