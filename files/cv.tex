...
\begin{cvchrono}{AWARDS, FELLOWSHIPS, AND GRANTS}
	\cvitem{2026}{IQAM Best Paper Award, Cognitive Foundations in Finance Conference Best Paper Award, Swiss Finance Institute Outstanding Paper Award}
...
\begin{cvchrono}{PRESENTATIONS (INCLUDES SCHEDULED)}
	\cvitem{2026}{\textit{Seminars}: Federal Reserve Bank of Philadelphia (x2), Duke Economics, CIBC Finance Innovations \& AI Seminar, NYU Stern, Harvard Business School \newline \textit{Conferences}: CEPR 11th European Workshop on Household Finance, FMG Conference on Cognitive Foundations of Finance, WFA, NBER SI Household Finance, Stanford SITE Public Economics, SIEPR Conference on Budget Analysis and Public Policy}
